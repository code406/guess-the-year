<article class="text-center flex flex-col justify-center items-center [text-wrap:balance] py-10 px-8">
    ...
    <p class="text-xl w-10/12 3xs:w-4/6 2xs:w-7/12 xs:w-full mt-4 xs:mt-0">Answers range from 1900 to 2021.</p>
    <p class="mt-6 text-[var(--pico-muted-color)]">Playing Time: 1-2 minutes.</p>
    <a href="/game" role="button" class="mt-8 py-2 font-bold">start game</a>
</article>
